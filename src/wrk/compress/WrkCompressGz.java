 ...
 *
 * Workeur spécialisé dans la compression de données au format GNU-ZIP.
 *
 * @author <a href="mailto:friedlip@edufr.ch">Paolo Friedli</a>
 * @since 24.03.2014
 * @version 1.0.0
 */
public class WrkCompressGz extends WrkCompress {

    /**
     * L'extension de fichier correspondant à l'algorithme de compression mis en oeuvre par cette classe.
     */
    private final static String COMPRESSED_FILE_EXTENSION = ".gz";

    /**
     * Le nom correspondant à l'algorithme de compression mis en oeuvre par cette classe.
     */
    private final static String COMPRESSION_ALGORITHM_NAME = "GZIP";

    /**
     * Le constructeur de la classe.
     */
    public WrkCompressGz() {
